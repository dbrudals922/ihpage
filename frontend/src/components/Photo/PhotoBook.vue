<template>
  <!-- 사진첩 전체 레이아웃 -->
  <div class="container entire" style="height:fit-content;">
      ...
      <div class="row justify-content-end">
        ...
        <div class="col">
          ...
          <div class="row justify-content-end" style="width:inherit">
            ...
            <div class="col-2">
              <button class="btn btn-outline-primary m-3" id="Submit" @click="uploadPost">Share</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- mobile upload image sheet -->
    <div class="container uploadBoxMB" v-if="uploadImages">
      <button class="btn" id="Cancel" @click="cancelPost">&lt</button>
      <!-- progress bar -->
      <div class="progress" style="height: 3px;" v-if="isUploadingPhoto">
        <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0"
      ...
      <div class="previewBox">
        ...
        <!-- imagePreview -->
        <splide :options="preoptionsMB" ref="previewSplide">
          <splide-slide v-for="image in previewImages">
            <div class="imagePreviewWrapper" :style="{ 'background-image': `url(${image})` }" @click="chooseFiles()">
            </div>
          </splide-slide>
      ...
      <div class="mt-3">
        <textarea @input="inputHandler" maxlength="100" class="form-control" rows="6" v-model="text"
          style="resize: none;" id="textBox" placeholder="사진이 변환되는 동안 멋진 글을 작성해보세요!"></textarea>
        <p id="lengthText">{{ 100 - text.length }}/100</p>
        <div class="row justify-content-end" style="width:inherit">
          <!-- <div class="col-3">
          ...
          <div class="col-2">
            <button class="btn btn-outline-primary m-1" id="Submit" @click="uploadPost">Share</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <input id="fileUpload" class="form-control" type="file" accept="image/jpg, image/jpeg, image/png, image/heic" @input="pickFile"
      multiple hidden>
  </div>
...
export default {
  ...
  async setup(props, context) {
    ...
    const resizeWindow = () => {
      ...
      if (width < 768) {
        mainoptions.value["perPage"] = 2;
      }
      else {
        mainoptions.value["perPage"] = 7;
